...
## Pre-processing Data
These are the features were remove as it doesnt help to predict the outcome.
...
Choosen Knn method to build model. 
We use testing data to evaluate the performance of our model.
